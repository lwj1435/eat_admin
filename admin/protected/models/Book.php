...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('book_time, book_or_num, reserve_time, reach_time, begin_time, over_time, book_type, add_user_id, book_date, book_sex, order_id, commit_time, add_time, book_seat_type, book_seat_num, book_source_type, book_seat_id, delay_time, customer_id, pro_list, cou_list', 'required'),
			array('user_id, merchange_id, book_num, book_no, status, reserve_time, reach_time, begin_time, over_time, add_user_id, book_sex, order_id, commit_time, add_time, book_source_type, book_seat_id, delay_time, customer_id', 'numerical', 'integerOnly'=>true),
			array('account_name, user_name, book_phone, book_name, order_num', 'length', 'max'=>45),
			array('book_time', 'length', 'max'=>7),
			array('book_desc, pro_list, cou_list', 'length', 'max'=>255),
			array('book_or_num', 'length', 'max'=>30),
			array('book_type, book_seat_type, book_seat_num', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, account_name, user_name, merchange_id, book_time, book_desc, book_phone, book_name, book_num, book_no, order_num, status, book_or_num, reserve_time, reach_time, begin_time, over_time, book_type, add_user_id, book_date, book_sex, order_id, commit_time, add_time, book_seat_type, book_seat_num, book_source_type, book_seat_id, delay_time, customer_id, pro_list, cou_list', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('book_seat_num',$this->book_seat_num,true);
