...
class Promotions extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'goods_comment_num' => 'Goods Comment Num',
			'goods_marketing_num' => 'Goods Marketing Num',
			'goods_visit_times' => 'Goods Visit Times',
			'good_num' => 'Good Num',
			'share_times' => 'Share Times',
			'sound_times' => 'Sound Times',
			'goods_remain' => 'Goods Remain',
			'goods_image_list' => 'Goods Image List',
			'goods_over_time' => 'Goods Over Time',
			...
			'status' => 'Status',
			'goods_taste_tag' => 'Goods Taste Tag',
			'goods_sale_type' => 'Goods Sale Type',
			'goods_correlate' => 'Goods Correlate',
			'add_user_id' => 'Add User',
			'goods_v_type' => 'Goods V Type',
			't_begin_time' => 'T Begin Time',
			't_end_time' => 'T End Time',
			'pri_time_per' => 'Pri Time Per',
			'pri_goods_list' => 'Pri Goods List',
			'pri_goods_per' => 'Pri Goods Per',
			'vip_per' => 'Vip Per',
			'per_type' => 'Per Type',
			'varil_begin_time' => 'Varil Begin Time',
			'varil_end_time' => 'Varil End Time',
			'add_time' => 'Add Time',
			'goods_or_num' => 'Goods Or Num',
			'pri_money' => 'Pri Money',
			'pro_list' => 'Pro List',
			'cou_list' => 'Cou List',
			'goods_share_num' => 'Goods Share Num',
			'translate_type' => 'Translate Type',
			'sendout_num' => 'Sendout Num',
			'use_num' => 'Use Num',
			'view_num' => 'View Num',
		);
	}
