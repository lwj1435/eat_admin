...
class TakeOut extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('take_out_num, price_count, take_num_count, merchant_id, status, add_time, take_out_name, take_out_type, favorable_id, pay_type, pay_status, add, take_out_status, super_need, take_num, take_out_date, take_out_time, take_out_phone', 'required'),
			array('user_id, price_count, take_num_count, take_time, pro_time, out_time, get_time, merchant_id, status, add_time, take_out_type, pay_type, pay_status, take_out_status, take_num, customer_id', 'numerical', 'integerOnly'=>true),
			...
			array('id, take_out_num, user_id, account_name, user_name, user_phone, order_num, price_count, take_num_count, take_outcol, take_time, pro_time, out_time, get_time, merchant_id, status, add_time, take_out_name, take_out_type, favorable_id, pay_type, pay_status, add, take_out_status, super_need, take_num, take_out_date, take_out_time, customer_id, take_out_phone', 'safe', 'on'=>'search'),
		);
	}
