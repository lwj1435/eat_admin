 ...
 */
class AddManageUse extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('account_name, username, sex, password, iphone, merchant_id', 'required'),
			...
			array('iphone', 'match', 'allowEmpty'=>true, 'pattern'=>'/^[\d]{11}$/i','message'=>'绑定手机必须为11位手机号码'),
	 ...
	 * @return AddManageUse the static model class
	 */
