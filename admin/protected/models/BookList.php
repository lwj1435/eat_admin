...
class BookList extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('book_time, book_or_num, reserve_time, reach_time, begin_time, over_time, book_type, add_user_id, book_date, book_sex, commit_time, add_time, book_seat_type, book_seat_num, book_source_type, book_seat_id', 'required'),
            array('user_id, merchange_id, book_num, book_no, status, reserve_time, reach_time, begin_time, over_time, add_user_id, book_sex, commit_time, add_time, book_seat_num, book_source_type, book_seat_id', 'numerical', 'integerOnly'=>true),
