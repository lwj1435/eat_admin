...
if($sGoodsVType==$iKey){
                ...
                <div class="control-group" id='perType1'>
                  ...
                  <div class="controls">
                    <input type="text" placeholder="限时开始时段" data-title="请选择优惠时段" class="span3 tip-right" onClick="WdatePicker({dateFmt:'HH:mm'})" value="<?=isset($info['t_begin_time'])?$info['t_begin_time']:''; ?>" name="PromotionFrom[t_begin_time]" data-original-title="">
                    <input type="text" placeholder="限时结束时段" data-title="请选择优惠时段" class="span3 tip-right" onClick="WdatePicker({dateFmt:'HH:mm'})" value="<?=isset($info['t_end_time'])?$info['t_end_time']:''; ?>" name="PromotionFrom[t_end_time]" data-original-title="">
...
<!--                       <input type="text" placeholder="优惠折扣" data-title="请填写促销标题全称" class="span6 tip-right" data-original-title=""> -->
                ...
                <div class="control-group" id='perType2'>
                  ...
                  <div class="controls">
                  	...
                  	<select multiple placeholder="餐厅提供的服务，如:早茶、午市、外卖等" name="PromotionFrom[pri_goods_list][]" class="span6" >
										<?php
...
<!--                           <button class="btn btn-warning" type="button">短期促销</button> -->
                    ...
                    <?php echo $form->labelEx($model,'开始日期',array('class'=>"control-label")); ?>
                      <div class="controls">
                        <input type="text" onclick='WdatePicker();' data-date-format="yyyy-mm-dd"  value="<?=isset($info['varil_begin_time'])?$info['varil_begin_time']:''; ?>" name="PromotionFrom[varil_begin_time]"   class=" span11">
                    ...
                    <?php echo $form->labelEx($model,'结束日期',array('class'=>"control-label")); ?>
                      <div class="controls">
                        <input type="text"  onclick='WdatePicker();' data-date-format="yyyy-mm-dd"  value="<?=isset($info['varil_end_time'])?$info['varil_end_time']:''; ?>" name="PromotionFrom[varil_end_time]" class=" span11">
