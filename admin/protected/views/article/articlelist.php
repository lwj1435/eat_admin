...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo $this->createUrl("site/index");?>" title="主页" class="tip-bottom"><i class="icon-home"></i> 主页</a> <a href="<?php echo $this->createUrl("article/index");?>">文章列表</a> </div>
  </div>
<!--End-breadcrumbs-->
            ...
            <table class="table table-bordered table-striped with-check">
              ...
              ?>
                <tr>
                  ...
                  <td>Trident</td>
                  <td>Internet Explorer <?php echo $i;?></td>
                  <td>Win 95+</td>
                  <td>4</td>
                  <td>4</td>
                  <td><a href="#">编辑</a>&nbsp;|&nbsp;<a href="#"><font color='red'>删除</font></a></td>
                </tr>
                <?php 
              	}
              }
