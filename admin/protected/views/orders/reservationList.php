				...
				<div class="todo">
                      <ul>
                        ...
                        <li class="clearfix">
                              ...
                              <div class="txt2" style="width:20%"><a class="tip" title="点击展开/收起订单" data-parent="#collapse-group" href="#showDiv<?php echo $item->id;?>" onclick="diableAllDiv('showDiv<?php echo $item->id;?>');" data-toggle="collapse"><span class="badge <?php echo isset($aArrBookTypeCss[$item->book_type])?$aArrBookTypeCss[$item->book_type]:'';?>"><?php echo  ($item->book_no>0)? $item->book_type.$item->book_no:"等号中";
                              	?></span></a>
...
<!--                               </div> -->
                              ...
                              <div  class="collapse accordion-body" id="showDiv<?php echo $item->id;?>" name="showDiv" style="width:100%">
...
<script>
function diableAllDiv(id){
      $("div[name=showDiv]").each(function() {  
		if($(this).attr('id')==id){
			document.getElementById($(this).attr('id')).style.display="";
		}else{
	    	$(this).attr('class','accordion-body collapse');
