    ...
    <div class="row-fluid">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-briefcase"></i> </span>
            <h5 >订单编号：<?php echo $abookArr['book_or_num']?$abookArr['book_or_num']:'';?></h5>
          </div>
            ...
            <div class="row-fluid">
              <div class="span6">
                <table border="0" cellpadding="0" cellspacing="0" class="" style="font-size:14px;">
                  <tbody>
                    <tr>
                      <td><h3><?php echo isset($abookArr['book_name'])?$abookArr['book_name']:''; ?></h3></td>
                    </tr>
                    <tr><?php echo isset($abookArr[''])?$abookArr['']:''; ?>
                      <td>广东省/广州市/天河区</td>
                      <td>客户电话：<?php echo isset($abookArr['book_phone'])?$abookArr['book_phone']:''; ?></td>
                    </tr>
                    <tr>
                      <td>联系电话：<?php echo isset($abookArr['book_phone'])?$abookArr['book_phone']:''; ?></td>
                      <td>联系人：<?php echo isset($abookArr['book_name'])?$abookArr['book_name']:''; ?></td>
                    </tr>
                    <tr>
...
<!--                     </tr>                     -->
                ...
                <table class="table table-bordered table-striped" style="font-size:14px">
                  <tbody>
                    <tr>
                      <td width="80%"><h4>付款方式：<a href="#" class="tip-bottom" title="Wire Transfer">餐到付款</a></h4></td>
                      <td width="10%"><strong>小计总价</strong> <br>
                        <strong>优惠价格</strong></td>
                      <td width="10%"><strong>￥0 <br>
                        ￥0</strong></td>
                    </tr>
                  </tbody>
                </table>
                <div class="pull-right">
                  <h4><span>实际付款金额:</span> ￥0</h4>
                  <br>
